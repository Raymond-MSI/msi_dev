...
?>
	...
	class Databases
	{
		...
		function get_dataV2($tablename, $condition = "", $order = "", $startRows = 0, $maxRows = 0)
		{
			$mysql = 'SELECT * FROM sa_' . $tablename;
			if ($condition != '') {
				$mysql .= ' WHERE ' . $condition;
			...
			// Revisi script
			// Update 26 Juni 2023
			// Perubahan res menggunakan get_sqlV2

			$data = $this->get_sqlV2($mysql);
			return $data;
		}
		...
		function last_insert_data($tablename, $insert)
		{
