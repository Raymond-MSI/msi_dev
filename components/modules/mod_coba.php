...
?>
                    ...
                    buttons: [{
                        ...
                        },
                        {
                            ...
                            action: function() {
                                ...
                                window.location.href = "index.php?mod=coba&act=view&id=" + id + "&submit=Submit";
                            },
                            enabled: false
                        },
                        {
                            ...
                            action: function() {
                                ...
                                var id = table.cell(rownumber, 0).data();
                                window.location.href = "index.php?mod=coba&act=edit&id=" + id + "&submit=Submit";
                            }
                        },
                        {
                            text: "<i class='fa fa-plus'></i>",
                            action: function() {
                                window.location.href = "index.php?mod=coba&act=add";
                            },
                            // enabled: false
                        }
                    ],
        ...
        {
            include("components/modules/coba/form_coba.php");
        }

        // End Function

        $database = 'sa_new';
        include("components/modules/coba/connection.php");
        $DB = new Databases($hostname, $username, $userpassword, $database);
        $tblname = 'coba';

        include("components/modules/coba/func_coba.php");
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">coba</h6>
                </div>
                <div class="card-body">
                    <?php
                    if (!isset($_GET['act'])) {
