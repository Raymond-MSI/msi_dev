...
?>
                    ...
                    buttons: [{
                        ...
                        },
                        {
                            ...
                            action: function() {
                                ...
                                var answer_id = table.cell(rownumber, 0).data();
                                window.location.href = "index.php?mod=survey_answer&act=view&answer_id=" + answer_id + "&submit=Submit";
                            },
                            enabled: false
                        },
                        {
                            ...
                            action: function() {
                                ...
                                var answer_id = table.cell(rownumber, 0).data();
                                window.location.href = "index.php?mod=survey_answer&act=edit&answer_id=" + answer_id + "&submit=Submit";
                            }
                        },
                        {
                            text: "<i class='fa fa-plus'></i>",
                            action: function() {
                                window.location.href = "index.php?mod=survey_answer&act=add";
                            },
                            // enabled: false
                        }
                    ],
        ...
        if ($_SESSION['Microservices_UserLevel'] == "Super Admin") {
            ...
            {
                include("components/modules/survey_answer/form_survey_answer.php");
            }

            // End Function

            $database = 'sa_survey';
            include("components/modules/survey_answer/connection.php");
            $DB = new Databases($hostname, $username, $userpassword, $database);
            $tblname = 'trx_survey';

            include("components/modules/survey_answer/func_survey_answer.php");
