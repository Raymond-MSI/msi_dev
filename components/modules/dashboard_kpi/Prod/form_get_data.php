sta<?php
    ...
    if ($_GET['act'] == 'edit') {
        ...
        do {
            ...
            $check_data = $DBKPI->get_sql("SELECT Nama,project_code,so_number FROM sa_user WHERE Nama='$nama_email' AND so_number='$no_so'");
            if (isset($check_data[0]['Nama'])) {
        ...
        do {
            ...
            $check_data = $DBKPI->get_sql("SELECT Nama FROM sa_user WHERE Nama LIKE '%$nama_email%' AND so_number='$so_number' AND role LIKE '%$resource_role%' AND periode_so='$periode_so'");
            if (empty($check_data[0]['Nama'])) {
        ...
        $query_get_cr_data = $DBCR->get_sql("SELECT a.project_code,a.so_number,SUM(b.mandays_value) AS mandays_cr from sa_general_informations a left join sa_mandays b on a.cr_no=b.cr_no WHERE a.change_request_approval_type='submission_approved' AND a.change_request_approval_type2='submission_approved' AND a.CR_status_approval_pmo='submission_approved' AND a.CR_status_approval_presales='submission_approved' GROUP BY a.cr_no");
