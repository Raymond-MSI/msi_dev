...
?>
            ...
            $(document).ready(function() {
                var table = $('#view_documents').DataTable({
                    ...
                    buttons: [
                        ...
                        {
                            text: "<span class='d-inline-block' tabindex='0' data-bs-toggle='tooltip' title='View Document'><i class='fa fa-xmark'></i></span>",
                            action: function() {
                                var rownumber = table.rows({
                                    selected: true
                                }).indexes();
                                ...
                                if (doc_id == null) {
                                    ...
                                    window.location.href = "index.php?mod=legal_documents&act=delete&doc_id=" + doc_id + "&submit=Submit";
                                }
                            },
                            enabled: true
                        },
        ...
        if ($setupDB[2] > 0) {
            ...
            if ($json_conn['version']['connection'] == "4") {
                ...
                $DBLD = new Databases($hostname, $username, $password, $database);
