...
$check_approval = $DBHCM->get_sql("SELECT * FROM sa_view_employees WHERE job_level LIKE '%2%' AND resign_date IS NULL OR employee_name LIKE '%aditya wisnu%' ORDER BY employee_name");
...
<form method="post" action="index.php?mod=<?php echo $_GET['mod']; ?>">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="customer_name" name="customer_name" value="<?php echo $query_kpi[0]['customer_name']; ?>" readonly>
                    </div>
                </div>
                <div class="row mb-2">
            ...
            <div class="col-lg-6">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="project_name" name="project_name" value="<?php echo $query_kpi[0]['project_name']; ?>" readonly>
                    </div>
                </div>
                <div class="row mb-2">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-8">
                        <?php
                        $get_survey_id = $DBSV->get_sql("SELECT a.*,b.rating_average FROM sa_survey a left join sa_trx_survey b ON a.survey_id=b.survey_id WHERE a.so_number='" . $_GET['so_number'] . "'");
                            if (isset($get_survey_id[0]['rating_average'])) {
                        ?>
                            <input type="text" class="form-control form-control-sm" value="<?php echo $get_survey_id[0]['rating_average']; ?>" readonly>
                        <?php
                        } else {
                        ?>
                ...
                <div class="row mb-2">
                    ...
                    <div class="form-group col-sm-8">
                        <?php if (isset($check_error[0]['pic_email'])) { ?>
                            <textarea cols="35" name="pic" value="<?php echo $check_error[0]['pic_email']; ?>" readonly><?php echo $check_error[0]['pic_email']; ?></textarea>
                        <?php } else if (isset($check_data[0]['pic_email'])) { ?>
                            <textarea name="pic" cols="35" value="<?php echo $check_data[0]['pic_email']; ?>" readonly><?php echo $check_data[0]['pic_email']; ?></textarea>
                        <?php } else { ?>
                ...
                <div class="row mb-5">
                    <label for="inputCID3" class="col-sm-3 col-form-label col-form-label-sm">Tanggal Internal Closing</label>
                    <div class="col-sm-1">
                        <label for="inputCID3" class="col-sm-1 col-form-label col-form-label-sm">:</label>
                    </div>
                    <div class="col-sm-8">
                        <?php
                        if (isset($check_data[0]['tanggal_ic'])) {
                        ?>
                            <input type="date" class="form-control form-control-sm" name="tanggal_ic" value="<?php echo $check_data[0]['tanggal_ic']; ?>" readonly>
                        <?php
                        } else {
                        ?>
                            <input type="date" class="form-control form-control-sm" name="tanggal_ic" readonly>
                        <?php
                        }
                        ?>
                    </div>
    ...
    ?>
        ...
        $cekcr_so = $DBCR->get_sql("SELECT * FROM sa_general_informations WHERE so_number='" . $_GET['so_number'] . "' AND cr_no LIKE '%IM%'");
        $cekcr_kp = $DBCR->get_sql("SELECT * FROM sa_general_informations WHERE project_code='" . $_GET['project_code'] . "' AND cr_no LIKE '%IM%'");
        ?>
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="info-tab" data-bs-toggle="tab" data-bs-target="#informationx" type="button" role="tab" aria-controls="generalinformation" aria-selected="false" style="color: black;">Information</button>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="row mb-5">
                    ...
                    <div class="form-group col-sm-8">
                        <?php if (isset($check_data[0]['pic_email'])) { ?>
                            <textarea cols="35" name="pic" value="<?php echo $check_data[0]['pic_email']; ?>" readonly><?php echo $check_data[0]['pic_email']; ?></textarea>
                        <?php } else { ?>
                            <select class="form-control" name="pic_board[]" multiple>
                                <?php do { ?>
                                    <option value="<?php echo $check_approval[0]['employee_email']; ?>"><?php echo $check_approval[0]['employee_name'] . "/" . $check_approval[0]['employee_email']; ?></option>
            ...
            <div class="col-lg-6">
                            ...
                            <div class="name-list">
                                <ul>
                                    ...
                                    do {
                                        $get_name = $DBHCM->get_sql("SELECT employee_name,employee_email from sa_view_employees WHERE employee_email='" . $get_engineer[0]['resource_email'] . "'");
                                        $get_leader_resource = get_leader($get_engineer[0]['resource_email']);
                                        if (isset($get_name[0]['employee_name'])) {
                                            $get_namanya = $get_name[0]['employee_name'];
                                            $get_nama_leader = $get_leader_resource[0]['leader_name'];
                                            $get_email = $get_name[0]['employee_email'];
                                        } else {
                                            $get_namanya = "";
                                            $get_nama_leader = "";
                                            $get_email = "";
                                    ...
                                    ?>
                                        <li type="text" name="resources" id="resources" value="<?php echo $get_namanya; ?>" readonly><?php echo $get_namanya . " (" . $get_nama_leader . ")"; ?></li>
                                        <input type="hidden" name="resources[]" id="resources[]" value="<?php echo $get_email;?>">
                                    <?php
                                    } while ($get_engineer[0] = $get_engineer[1]->fetch_assoc());
                                    ?>
                                </ul>
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-sm-8">
                        ...
                        if (isset($check_data[0]['tanggal_ic'])) {
                        ?>
                            <input type="date" class="form-control form-control-sm" name="tanggal_ic" value="<?php echo $check_data[0]['tanggal_ic']; ?>">
                        <?php
                        } else {
                        ?>
                            <input type="date" class="form-control form-control-sm" name="tanggal_ic">
                        <?php
                        }
                        ?>
                    </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        do {
                                            ...
                                            $cost_cr = $DBCR->get_sql("SELECT * FROM sa_change_cost_plans WHERE cr_no='$cr_no'");
                                            $cost_type = $cost_cr[0]['cost_type'];
                                            $cost_responsibility = $cost_cr[0]['responsibility'];
                                            $change_reason = $cost_cr[0]['change_reason'];
                                            ...
                                            echo "<tr><td><input type='text' name='cr_no[]' value='$cr_no'></td><td>$class</td><td>$scope</td><td>$cost_type</td><td>$cost_responsibility</td><td>$change_reason</td><td>$status</td>"; ?>
                                            <?php if ($status == "Open") { 
                                                $cr = $cr_no;
                                                ?>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        do {
                                            ...
                                            $cost_cr_kp = $DBCR->get_sql("SELECT * FROM sa_change_cost_plans WHERE cr_no='$cr_no'");
                                            $cost_type = $cost_cr_kp[0]['cost_type'];
                                            $cost_responsibility = $cost_cr_kp[0]['responsibility'];
                                            $change_reason = $cost_cr_kp[0]['change_reason'];
                                            if ($status1 == "submission_to_be_reviewed") {
                                                $status = "Open";
                                            } else if ($status1 == "Canceled") {
                                                $status = "Cancel";
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="form-group col-sm-8">
                                        <textarea cols="35" <?php echo "disabled"; ?> readonly><?php echo $check_data[0]['pic_email']; ?></textarea>
                                    </div>
                                </div>
                                <?php } else if (isset($check_error[0]['pic_email'])) { ?>
                                <div class="row mb-2">
                                    <label for="inputCID3" class="col-sm-3 col-form-label col-form-label-sm">KPI Board</label>
                                    <div class="col-sm-1">
                                        <label for="inputCID3" class="col-sm-1 col-form-label col-form-label-sm">:</label>
                                    ...
                                    <div class="form-group col-sm-8">
                                        <textarea cols="35" <?php echo "disabled"; ?> readonly><?php echo $check_error[0]['pic_email']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row mb-5">
                                    <label for="inputCID3" class="col-sm-3 col-form-label col-form-label-sm">Nilai Project</label>
	...
	<?php
    if ($_GET['act'] == 'test') {
    $query = $DBKPI->get_sql("SELECT * FROM sa_kpi_so_wr");
do {
  $so_number = $query[0]['so_number'];
  $query2 = $DBWR->get_sql("SELECT DISTINCT a.resource_email from sa_view_dashboard_wrike_resource a left join sa_wrike_project_list b ON a.project_id=b.id where b.no_so='$so_number'");?>
  <input type="text" name="so_number[]" value="<?php echo $so_number ?>">
<?php do { ?>
    <input type="text" name="test[]" value="<?php echo $query2[0]['resource_email'] ?>">
  <?php 
  } while ($query2[0] = $query2[1]->fetch_assoc());
} while ($query[0] = $query[1]->fetch_assoc());
?>
</br>
<input type="submit" class="btn btn-primary" name="submit_resource" value="Submit Resource">
    <?php
    }
    ?>
	...
	<!-- <input type="submit" class="btn btn-primary" name="testing" value="testing"> -->
