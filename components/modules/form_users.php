            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="1" name="user_status" id="user_status" <?php echo ($users[0]['user_status']==1 ? 'checked' : 'unchecked'); ?>>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <select class="select-control" name="<?php echo $dmodules['config_value']; ?>_id">
                                ...
                                <?php do { ?>
                                    ...
                                    <?php if($taccess>0) { if($dlevel['user_level_id'] == $daccess['user_level_id']) { 
                                        echo "selected"; }} else { echo "selected"; } ?>>
