...
if ($dtWrileProjectList[2] > 0) {
    ...
    do {
            ...
            do {
                ...
                if ($employees[2] > 0) {
                    ...
                    if (array_search($dtWrikeAssignment[0]['resource_email'], $DataResource) == '') {
                        ...
                        $mysql = sprintf(
                            "SELECT DISTINCT `Nama`, `total_nilai_ideal`, `total_nilai_aktual`, `hasil_aktual_ideal`, `total_nilai_akhir_ideal`, `total_nilai_akhir_aktual`, `hasil_akhir_aktual_ideal` FROM `sa_user_kpi` WHERE `periode_so` %s AND `Nama` LIKE %s AND `kpi_status` %s",
                            GetSQLValueString($periode_so, "defined", $periode_so, ""),
                        ...
                        if ($kpiResourcex[2] > 0) {
                            do {
                                ...
                                if (array_search($email[0], $DataResource) == '') {
                                    ...
                                    $condition = sprintf(
                                        'Nama LIKE %s AND kpi_status %s AND periode_so %s',
        ...
        $mysql = "SELECT COUNT(a.task_name) AS total_task FROM sa_preschedule a left join sa_schedule b ON a.google_event_id=b.event_id WHERE a.project_id='" . $dtWrileProjectList[0]['id'] . "' AND b.response_status <>'declined'";
        // $dtWrikeTask = $DBWRIKE->get_sql($mysql);
        $dtWrikeTask = $DBGC->get_sql($mysql);
        $KPIProject .= '<td class="align-top">';
        ...
        $mysql = "SELECT COUNT(a.project_id) as total_update FROM sa_preschedule a left join sa_schedule b ON a.google_event_id=b.event_id WHERE a.project_id = '" . $dtWrileProjectList[0]['id'] . "' AND b.response_status='accepted' AND b.diff_time<>0";
        // $dtWrikeTaskUpdate = $DBWRIKE->get_sql($mysql);
        $dtWrikeTaskUpdate = $DBGC->get_sql($mysql);
        ...
        $condition = "`order_number` = '" . $dtWrileProjectList[0]['order_number'] . "'";
        $dtKPIDataSO = $DBKPI->get_data($tblname, $condition);

        if ($dtKPIDataSO[2] > 0) {
            //Commercial
            $KPIProject .=
                '<td class="align-top">' . number_format(($dtWrileProjectList[0]['commercial_kpi'] > 0 ? $dtWrileProjectList[0]['commercial_kpi'] * 100 : 0), 2) . '&nbsp;&nbsp;|&nbsp;&nbsp;' . $dtWrileProjectList[0]['commercial_category'] . '&nbsp;&nbsp;<br>
            <span style="font-size:13px">' . number_format($dtKPIDataSO[0]['SB_mandays_implementation'], 0) . '&nbsp;&nbsp;|&nbsp;&nbsp;' .
                ...
                number_format($dtKPIDataSO[0]['WR_mandays_actual_implementation'], 0) . '</span></td>';
...
<div class="row mb-3">
    ...
    <div class="col-lg-4">
        ...
        $mysql = sprintf(
            "SELECT IFNULL(SUM(CAST(REPLACE(`nilai_akhir_aktual`, ',', '.') AS Decimal(10,2))),0) AS `actual_final_value`, IFNULL(SUM(CAST(REPLACE(`nilai_akhir_ideal`, ',', '.') AS Decimal(10,2))),0) / IFNULL(SUM(REPLACE(`nilai_akhir_aktual`, ',', '.')),1) * 100 AS `average_resource` FROM `sa_user` WHERE  %s `kpi_status` = %s GROUP BY `Nama`; ",
    ...
    <div class="col-lg-12">
        <div class="card-body">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-body fw-bold" id="submit-tab" data-bs-toggle="tab" data-bs-target="#subOrdinate" type="button" role="tab" aria-controls="subOrdinate" aria-selected="false" title='SB yang sudah disubmit ke manager'>KPI Summary</button>
                </li>
            </ul>
            <div class="tab-content" id="myTabContent">
                            ...
                            <table class="display" id="CTEResource" width="100%">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                        <tr>
                                            <td colspan="8">No data to displayed.</td>
                                        </tr>
                                    <?php
                                    }
                                    ?>
                ...
                <div class="tab-pane" id="subOrdinate" role="tabpanel" aria-labelledby="subOrdinate-tab">
                    ...
                    <!-- <tr>
                                                    <td><?php //echo $emailx; 
                                                        ?></td>
                                                    <td class="text-nowrap"><?php //echo $img . "&nbsp;" . $emailx; 
                                                                            ?></td>
                                                    <td><?php //echo number_format($dtResources[0]['ideal_value'], 2); 
                                                        ?></td>
                                                    <td><?php //echo number_format($dtResources[0]['actual_value'], 2); 
                                                        ?></td>
                                                    <td><?php //echo number_format($dtResources[0]['average'], 2); 
                                                        ?></td>
                                                    <td><?php //echo number_format($dtResources[0]['ideal_final_value'], 2); 
                                                        ?></td>
                                                    <td><?php //echo number_format($dtResources[0]['actual_final_value'], 2); 
                                                        ?></td>
                                                    <td><?php //echo number_format($dtResources[0]['average_resource'], 2); 
                                                        ?></td>
                                                    <td><?php //echo $periode_sox; 
                                                        ?></td>
                                                </tr> -->
                    <?php
                    ...
                    ?>
                    <!-- <tr>
                                                                    <td><?php //echo $dtResources2[0]['Nama']; 
                                                                        ?></td>
                                                                    <td class="text-nowrap">- <?php //echo $img2 . "&nbsp;" . $dtResources2[0]['Nama']; 
                                                                                                ?></td>
                                                                    <td><?php //echo number_format($dtResources2[0]['ideal_value'], 2); 
                                                                        ?></td>
                                                                    <td><?php //echo number_format($dtResources2[0]['actual_value'], 2); 
                                                                        ?></td>
                                                                    <td><?php //echo number_format($dtResources2[0]['average'], 2); 
                                                                        ?></td>
                                                                    <td><?php //echo number_format($dtResources2[0]['ideal_final_value'], 2); 
                                                                        ?></td>
                                                                    <td><?php //echo number_format($dtResources2[0]['actual_final_value'], 2); 
                                                                        ?></td>
                                                                    <td><?php //echo number_format($dtResources2[0]['average_resource'], 2); 
                                                                        ?></td>
                                                                    <td><?php //echo $periode_sox; 
                                                                        ?></td>
                                                                </tr> -->
                    ...
                    ?>
                    <!-- <tr>
                                                                                    <td><?php //echo $dtResources3[0]['Nama']; 
                                                                                        ?></td>
                                                                                    <td class="text-nowrap">- <?php //echo $img3 . "&nbsp;" . $dtResources3[0]['Nama']; 
                                                                                                                ?></td>
                                                                                    <td><?php //echo number_format($dtResources3[0]['ideal_value'], 2); 
                                                                                        ?></td>
                                                                                    <td><?php //echo number_format($dtResources3[0]['actual_value'], 2); 
                                                                                        ?></td>
                                                                                    <td><?php //echo number_format($dtResources3[0]['average'], 2); 
                                                                                        ?></td>
                                                                                    <td><?php //echo number_format($dtResources3[0]['ideal_final_value'], 2); 
                                                                                        ?></td>
                                                                                    <td><?php //echo number_format($dtResources3[0]['actual_final_value'], 2); 
                                                                                        ?></td>
                                                                                    <td><?php //echo number_format($dtResources3[0]['average_resource'], 2); 
                                                                                        ?></td>
                                                                                    <td><?php //echo $periode_sox; 
                                                                                        ?></td>
                                                                                </tr> -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- <div class="row mb-2">
                                ...
                                <div class="col-sm-2">
                                    <select class="form-select" aria-label="Default select example" id="type" onchange="loadpage()">
                                        <option value="implementation" <?php //echo ((isset($_GET['type']) && $_GET['type']=="implementation") ? "Selected" : ""); 
                                                                        ?>>Implementation</option>
                                        <option value="maintenance" <?php //echo ((isset($_GET['type']) && $_GET['type']=="maintenance") ? "Selected" : ""); 
                                                                    ?>>Maintenance</option>
                                    </select>
                                </div>
                            </div> -->
                            ...
                            <div class="table-responsive">
                                <table class="display" id="Resources" width="100%">
