...
$(document).ready(function() {
    ...
    $('#ProjectList tbody').on('dblclick', 'tr', function() {
        ...
        $("#div2").load("components/modules/kpi_project/dashboard_kpi_detail.php?project_id=" + data1[
            7]);
    ...
    $('#KPIResource tbody').on('dblclick', 'tr', function() {
        ...
        $("#div2").load("components/modules/kpi_project/dashboard_kpi_resource.php?resource=" + exp2[
            0] + "&status_review=" + review + "&periode_kpi=" + data2[10]);
    ...
    $('#Resources tbody').on('dblclick', 'tr', function() {
        ...
        $("#PopUpModal").modal("show");
        document.getElementById("div1").innerHTML = '';
        $("#div2").load("components/modules/kpi_project/dashboard_kpi_summary_detail.php?resource=" +
            exp2[0]);
...
if($_SESSION['Microservices_UserEmail']=="hendri@mastersystem.co.id" || $_SESSION['Microservices_UserEmail']=="syamsul@mastersystem.co.id" || $_SESSION['Microservices_UserEmail']=="chrisheryanda@mastersystem.co.id" || $_SESSION['Microservices_UserEmail']=="lucky.andiani@mastersystem.co.id" || $_SESSION['Microservices_UserEmail']=="ary.mulyati@mastersystem.co.id" || $_SESSION['Microservices_UserEmail']=="henny.anggra@mastersystem.co.id")
{
...
if(isset($_GET['resource']))
{
    ...
    if($res[2]>0)
    {
        $SubOrdinates = " AND `b`.`Nama` IN ('" . $email[2] . "'" . $res[0]['subordinate'] . ")";
    }
...
<div class="col border-left-<?php echo $color; ?> p-3 ml-3 mr-3 h-100 py-<?php echo $py; ?>">
    <span
        class="text-<?php echo $color; ?> text-uppercase text-xs font-weight-bold mb-1"><?php echo $title; ?></span><br>
    <span
        class="<?php echo $fontsize; ?> mb-0 mr-3 font-weight-bold text-gray-800y d-flex flex-row align-items-center justify-content-between">
        <?php
            if (count($listData) > 0) {
            ?>
        <div class="dropdown no-arrow" id="<?php echo $tiptool; ?>">
            ...
            <div class="dropdown-menu dropdown-menu-left shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                ...
                <a class="dropdown-item"
                    href="index.php?mod=kpi_project&sub=<?php echo $_GET['sub'] . $listData[$i]['link'] . $resource; ?>"><?php echo $listData[$i]['value']; ?></a>
                <?php
                        }
                        ?>
            </div>
...
<div class="row mb-3">
    <div class="col-lg-4">
        <div class="card">
            <div
                class="card-header fw-bold text-<?php echo $MainColor; ?>-emphasis bg-<?php echo $MainColor; ?>-subtle">
            ...
            <div class="card-body">
                ...
                $mysql = sprintf(
                    "SELECT 
                        ...
                        COUNT(DISTINCT `a`.`project_id`) AS `total`
                    FROM
                ...
                if($rsCostUtilization[2]>0)
                {
                    ...
                    $TotalEmpty = 0;
                    do {
                        if(is_null($rsCostUtilization[0]['commercial_category'])==1)
                        {
                            $TotalEmpty += $rsCostUtilization[0]['total'];
                        } elseif($rsCostUtilization[0]['commercial_category']=="Empty")
                        {
                            $TotalEmpty += $rsCostUtilization[0]['total'];
                        } else
                        {
                    ...
                    if(strval(array_search("Empty", array_keys($CostTemp)))!="")
                    {
                        $xxx = array("label"=> "None", "y"=> $CostTemp['Empty']);
                        array_push($dataKPICostChart, $xxx);
                    } else
                    {
                        $xxx = array("label"=> "None", "y"=> 0);
                        array_push($dataKPICostChart, $xxx);
                    }
                }
                ?>
            ...
            <div
                class="card-footer fw-bold text-<?php echo $MainColor; ?>-emphasis bg-<?php echo $MainColor; ?>-subtle">
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                if($rsCostUtilization[2]>0)
                {
                    ...
                    $TotalEmpty = 0;
                    do {
                        if(is_null($rsCostUtilization[0]['time_category'])==1)
                        {
                            $TotalEmpty += $rsCostUtilization[0]['total'];
                        } elseif($rsCostUtilization[0]['time_category']=="Empty")
                        {
                            $TotalEmpty += $rsCostUtilization[0]['total'];
                        } else
                        {
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                if($rsCostUtilization[2]>0)
                {
                    ...
                    $TotalEmpty = 0;
                    do {
                        if(is_null($rsCostUtilization[0]['error_category'])==1)
                        {
                            $TotalEmpty += $rsCostUtilization[0]['total'];
                        } elseif($rsCostUtilization[0]['error_category']=="Empty")
                        {
                            $TotalEmpty += $rsCostUtilization[0]['total'];
                        } else
                        {
    ...
    <div class="col-lg-12">
        <div class="card-body">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-body fw-bold" id="summary-tab" data-bs-toggle="tab"
                        data-bs-target="#tabSummary" type="button" role="tab" aria-controls="subOrdinate"
                        aria-selected="false" title='SB yang sudah disubmit ke manager'>KPI Summary</button>
                </li>
            </ul>
                                ...
                                <table class="display compact hover" id="ProjectList" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="align-top">
                                            ...
                                            <td>
                                                <?php
                                                        echo $rsProjectList[0]['project_name'];
                                                        ?>
                                            </td>
                                            <td>
                                                <?php
                                                        echo $rsProjectList[0]['project_code'];
                                                        ?>
                                            </td>
                                            <td>
                                                <?php
                                                        echo $rsProjectList[0]['so_number'];
                                                        ?>
                                            </td>
                                            <td>
                                                <?php
                                                        echo $rsProjectList[0]['order_number'];
                                                        ?>
                                            </td>
                                            <td>
                                                <?php
                                                        echo $rsProjectList[0]['customer_name'];
                                                        ?>
                                            </td>
                                        </tr>
                                        <?php
                                        ...
                                        ?>
                                        <script>
                                        document.getElementById("TeamProject").innerHTML =
                                            "<?php echo $rsProjectList[2]; ?>";
                                        document.getElementById("ProjectValue").innerHTML =
                                            "<?php echo number_format($ProjectValue, 2) . "M"; ?>";
                                        document.getElementById("TeamTask").innerHTML =
                                            "<?php echo number_format($TotalTaskPlan, 0); ?>";
                                        document.getElementById("TeamUpdate").innerHTML =
                                            "<?php echo number_format($TotalTaskActual, 0); ?>";
                            ...
                            <table class="display compact hover" id="KPIResource" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo ($rsResources[0]['task_plan']>0 ? number_format($rsResources[0]['task_actual']/$rsResources[0]['task_plan']*100, 2) : 0); ?></td>
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <table class="display compact hover" id="Resources" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $mysql = sprintf(
                                        "SELECT resource_name,SUM(implementation_reviewed) AS implementation_reviewed,SUM(implementation_not_reviewed) AS implementation_not_reviewed,SUM(maintenance_reviewed) AS maintenance_reviewed,SUM(maintenance_not_reviewed) AS maintenance_not_reviewed From sa_kpi_summary 
                                        GROUP BY
                                            `resource_name`
                                        ORDER BY
                                            `resource_name`;",
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            ...
                                            <?php echo $rsKPISummary[0]['implementation_not_reviewed']; ?>
                                            <!-- </button> -->
                                        </td>
    ...
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <script>
                $("#div3").load(
                    "components/modules/kpi_project/dashboard_kpi_summary_detail.php?resource=aditias.fauzi@mastersystem.co.id&status=Reviewed"
                );
                </script>
            </div>
            <div class="modal-footer">
