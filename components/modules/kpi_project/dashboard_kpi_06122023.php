...
$(document).ready(function () {
    ...
    $('#KPIResource tbody').on('dblclick', 'tr', function () {
        ...
        $("#div2").load("components/modules/kpi_project/dashboard_kpi_resource.php?resource="+exp2[0]+"&status_review="+review+"&periode_kpi="+data2[7]);
                    ...
                    <div class="card">
                        <div class="card-body table-responsive">
                            <table class="display compact hover" id="KPIResource" width="100%">
                                <thead class="text-<?php echo $MainColor; ?>-emphasis bg-<?php echo $MainColor; ?>-subtle">
                                    <tr class="text-center">
                                        <th class="text-warning-emphasis bg-warning-subtle" rowspan="2">Resource Name</th>
                                        <th class="text-primary-emphasis bg-primary-subtle" colspan="3">Average KPI - Project Full</th>
                                        <th class="text-success-emphasis bg-success-subtle" colspan="3">Average KPI - Project (Resource Specific)</th>
                                    </tr>
                                    <tr class="text-center">
                                        <th class="text-primary-emphasis bg-primary-subtle">Total KPI Project Ideal</th>
                                        <th class="text-primary-emphasis bg-primary-subtle">Total KPI Project Actual</th>
                                        <th class="text-primary-emphasis bg-primary-subtle">Average KPI Project</th>
                                        <th class="text-success-emphasis bg-success-subtle">Total KPI Project Ideal Resource Specific</th>
                                        <th class="text-success-emphasis bg-success-subtle">Total KPI Project Actual Resource Specific</th>
                                        <th class="text-success-emphasis bg-success-subtle">Average KPI Project Resource Specific</th>
                                        <th>Periode KPI</th>
                                        <th>KPI Status</th>
                                    </tr>
                                </thead>
