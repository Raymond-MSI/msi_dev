                                ...
                                <table class="display compact hover" id="ProjectList" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <script>
                                            ...
                                            document.getElementById("TeamTask").innerHTML = "<?php echo $TotalTaskPlan; ?>";
                                            document.getElementById("TeamUpdate").innerHTML = "<?php echo $TotalTaskActual; ?>";
