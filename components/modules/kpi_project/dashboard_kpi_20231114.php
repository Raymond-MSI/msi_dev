...
if ($dtWrileProjectList[2] > 0) {
    ...
    do {
        ...
        $mysql = "SELECT COUNT(task_name) AS total_task FROM sa_preschedule WHERE project_id='" . $dtWrileProjectList[0]['id'] . "'";
        // $dtWrikeTask = $DBWRIKE->get_sql($mysql);
        $dtWrikeTask = $DBGC->get_sqlV2($mysql);
        $KPIProject .= '<td class="align-top">';
        ...
        $mysql = "SELECT COUNT(a.project_id) as total_update FROM sa_preschedule a left join sa_schedule b ON a.google_event_id=b.event_id WHERE a.project_id = '" . $dtWrileProjectList[0]['id'] . "' AND b.response_status='accepted'";
