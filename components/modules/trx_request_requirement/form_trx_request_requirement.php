...
$query   = $DBNEWREQUEST->get_sql("SELECT * FROM sa_trx_request_requirement");
...
$narikstatus = $DBNEWREQUEST->get_data("status_k", "status_karyawan is not null");
...
$assign = $DBNEWREQUEST->get_sql("SELECT * FROM sa_assign where assign IS NOT NULL");
...
$linkfrom = $DBNEWREQUEST->get_sql("SELECT * FROM sa_link");
...
if (
    ...
    $dataemail = $DBNEWREQUEST->get_data("email", $kondisi);
    // var_dump($kondisi);
}
...
// bagian edit request by, gm, gmhcm,gmbod
    ...
    global $DBNEWREQUEST;
    $condition = "id=" . $_GET['id'];
    $data = $DBNEWREQUEST->get_data($tblname, $condition);
    $ddata = $data[0];
    $qdata = $data[1];
    $tdata = $data[2];
    ?>
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control" name="internal" id="internal" readonly>
                                                        <?php if ($_GET['act'] == "edit") { ?>
                                                            <?php $query = $DBNEWREQUEST->get_sql("SELECT * FROM sa_trx_request_requirement where id=" . $ddata['id'] . ""); ?>
                    ...
                    for ($i = 0; $i < count($sSubFolders); $i++) {
                        ...
                        if ($sSubFolders[$i] != "..") {
                            if (!(is_dir($xFolder))) {
                                ...
                                $file = 'media/documents/requestrequirement/index.php';
                                            ...
                                            <?php if ($_GET['act'] == 'editinterview') { ?>
                                                ...
                                                <?php } else { ?>
                                                    <table>
                                                        ...
                                                        <tr>
                                                            <?php if ($ddata['status_interview'] == "Submit" || $ddata['status_interview'] == "Selesai") { ?>
                            ...
                            <script>
                                $(document).ready(function() {
                                    $("#addemail").click(function() {
                                        ...
                                        html += '<div class="col-2 table-bordered"><b>Tanggal Interview</b><input type="date" class="form-control" name="tanggal_interview[]" id="tanggal_interview[]" rows="2"></input></div>';
                                        ...
                                        html += '<div class="col-2 table-bordered"><b>PIC</b><input type="text" class="form-control" name="pic[]" id="pic[]" rows="2"></input></div>';
                                        html += '<div class="col-3 table-bordered"><b>Interview User</b><select class="form-control mb-3" name="interview_user[]" id="interview_user[]" required>';
                                        <?php do {  ?>
                                        ...
                                        html += '</select></div>';
                                        html += '<div class="col-3 table-bordered"><b>Interview HCM</b><select class="form-control mb-3" name="interview_hcm[]" id="interview_hcm[]" required>';
                                        <?php do {  ?>
