        ...
        ?>
                        ...
                        buttons: [
                            ...
                            },
                            {
                               ...
                               action: function () {
                                   ...
                                   window.location.href = "index.php?mod=web_config&act=view&id="+id+"&submit=Submit";
                               },
                               enabled: false
                            },
                            {
                               ...
                               action: function () {
                                   var rownumber = table.rows({selected: true}).indexes();
                                   var id = table.cell( rownumber,0 ).data();
                                   window.location.href = "index.php?mod=web_config&act=edit&id="+id+"&submit=Submit";
                                }
                            },
                            {
                               text: "<i class='fa fa-plus'></i>",
                               action: function () {
                                   window.location.href = "index.php?mod=web_config&act=add";
                               },
                               // enabled: false
                            }
                        ],
          ...
          if($_SESSION['Microservices_UserLevel'] == "Administrator") {
              ...
              function form_data($tblname) {
                  include("components/modules/web_config/form_web_config.php"); 
              } 
    
              // End Function
    
              //$database = 'sa_microservices';
              //include("components/modules/web_config/connection.php");
              //$DB = new Databases($hostname, $username, $password, $database);
              $tblname = 'cfg_web';
    
              include("components/modules/web_config/func_web_config.php");
