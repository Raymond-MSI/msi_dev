...
?>
                    ...
                    buttons: [{
                        ...
                        },
                        {
                            ...
                            action: function() {
                                ...
                                window.location.href = "index.php?mod=hcm_request_requirement&act=view&id=" + id + "&submit=Submit";
                            },
                            enabled: false
                        },
                        {
                            ...
                            action: function() {
                                ...
                                var id = table.cell(rownumber, 0).data();
                                window.location.href = "index.php?mod=hcm_request_requirement&act=edit&id=" + id + "&submit=Submit";
                            }
                        },
                        {
                            text: "<i class='fa fa-plus'></i>",
                            action: function() {
                                window.location.href = "index.php?mod=hcm_request_requirement&act=add";
                            },
                            // enabled: false
                        }
                    ],
        ...
        if ($_SESSION['Microservices_UserLevel'] == "Super Admin") {
            ...
            {
                include("components/modules/hcm_request_requirement/form_hcm_request_requirement.php");
            }

            // End Function

            $database = 'sa_recruitment';
            include("components/modules/hcm_request_requirement/connection.php");
            $DBRec = new Databases($hostname, $username, $userpassword, $database);
            $tblname = 'trx_request_requirement';

            include("components/modules/hcm_request_requirement/func_hcm_request_requirement.php");
