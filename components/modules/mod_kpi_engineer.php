...
?>
        <script>
			...
			//{
				...
				if (id == null) {
                                    ...
                                    window.location.href = "components/modules/get_data/export_data_person.php?nama=" + nama;
                                }
                            }
                        }
                    ],
        ...
        function view_data($tblname)
        {
            ...
            $primarykey = "id";
            $condition = "Nama LIKE '%$hobi[0]%'";
            $order = "";
            if (isset($_GET['err']) && $_GET['err'] == "datanotfound") {
                global $ALERT;
                $ALERT->datanotfound();
            }
            view_table($DBEKPI, $tblname, $primarykey, $condition, $order);
        }
	...
	function form_data($tblname)
        ...
        if ($setupDB[2] > 0) {
            ...
            $DBEKPI = new Databases($hostname, $username, $userpassword, $database);
            $tblname = 'user';
            ...
            <div class="col-lg-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">KPI Engineer</h6>
                    </div>
                    <div class="card-body">
                        <?php
                        if (!isset($_GET['act'])) {
