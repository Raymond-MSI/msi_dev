...
$DB2 = new Databases('192.168.234.158', 'moodleuser', 'P@ssw0rd', $database2);
...
$listSO = array();
do {
    array_push($listSO, "<option value='".$data1['no_so']."' customer='".$data1['customer_name']."'>".$data1['project_code']." ( ".$data1['no_so']." )");
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.btn-primary').click(function(){
                ...
                if($('#pic_id').val() == ''){
                    ...
                    return false;
                }else if(survcount > 0 && $('#main_template_id option:selected').val() == ''){
        ...
        $('#pic_id').change(function(){
            ...
            if(survey_count > 0){
                ...
                $('#template_id').append("option value=''></option>");
                $('#template_id').append("<?php echo $listtempsimple; ?>");
            }else{
                $('#mainTemp').hide();
                $('#main_template_id option:selected').attr("selected",null);
                $('#template_id').append("option value=''></option>");
                $('#template_id').append("<?php echo $listtemp; ?>");
            }
            if(pic != ''){
                $.ajax({
                    url: "components/modules/ajax/ajax.php",
