...
window.onload = function () {
    ...
    var chart = new CanvasJS.Chart("chartSBSBundling", {
        animationEnabled: true,
        axisY:{
            title: "USD",
            lineColor: "#C24642",
        ...
        data: [{
            ...
            axisYType: "secondary",
            indexLabelFontSize: 11,
            dataPoints: <?php echo json_encode($dataSBIDR, JSON_NUMERIC_CHECK); ?>
        },
        {
            type: "column",
            name: "USD",
            ...
            // legendText: "{label}",
            indexLabelFontSize: 11,
            dataPoints: <?php echo json_encode($dataSBUSD, JSON_NUMERIC_CHECK); ?>
        }]
    });
    chart.render();
