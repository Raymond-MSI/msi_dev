                                        ...
                                        <div class="card shadow mb-1">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="row mb-3"><input type="text" class="form-control form-control-sm" id="request" name="request" value="<?php echo htmlspecialchars($subject1['request']) ?>" readonly>
                                                            </div>
                                                            <div class="row mb-3"><input type="text" class="form-control form-control-sm" id="id_request" name="id_request" value="<?php echo htmlspecialchars($subject1['id_request']) ?>" readonly>
                                                            </div>
                                                            <div class="row mb-3"><input type="text" class="form-control form-control-sm" id="subject" name="subject" value="<?php echo htmlspecialchars($subject1['subject']) ?>" readonly>
                                                            </div>
                                                            <div class="row mb-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control form-control-sm" id="assets" name="assets" value="<?php echo htmlspecialchars($responseData['request']['assets'][0]['name'] ?? 'Not Assigned') ?>" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
