...
if ($_GET['act'] == "add" || $_GET['act'] == "edit") {
    if(isset($_GET['project_code']) && isset($_GET['no_so'])) {
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form method="post" action="index.php?mod=<?php echo $_GET['mod']; ?>" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="hidden" id="emailSession"
                                value="<?php echo $_SESSION['Microservices_UserName'] . "<" . $_SESSION['Microservices_UserEmail'] . ">"; ?>" />
                            ...
                            <div class="col-sm-12 mb-2">
                                ...
                                <input type="text" class="form-control form-control-sm" id="project_code"
                                    name="projectCode"
                                    value="<?php if ($_GET['act'] == 'edit') {echo $ddata['project_code'];} ?>" required
                                    readonly>
                                <?php } ?>
                            </div>
                            ...
                            <div class="col-sm-12 mb-2">
                                ...
                                <?php }else{
                                if(isset($_GET['no_so'])){ ?>
                                <select id="noSO" class="form-control form-control-sm" name="noSO"
                                    onchange="onChangeSOFunction()" required>
                                    <option disabled>--Choose SO--</option>
                                    <option selected="selected" value="<?php echo $_GET['no_so']; ?>">
                                        <?php echo $_GET['no_so'];?></option>
                                    <?php 
                                        $sqlCheckSO = "SELECT DISTINCT no_so FROM sa_wrike_project_list WHERE project_code = '".$_GET['project_code']."'"; 
                            ...
                            <div class="col-sm-12 mb-2">
                                <?php if ($_GET['act'] == "add") { ?>
                                <?php if (isset($_GET['project_code']) && isset($_GET['no_so'])) { ?>
                                <?php if ($_GET['project_code'] == null || $_GET['no_so'] == null){ ?>
                                ...
                                <select id="projectType" class="form-control form-control-sm" name="projectType"
                                    onchange="onChangePTFunction()" required>
                                    ...
                                    <?php 
                                        $sqlCheckProjectType = "SELECT * FROM sa_wrike_project_list WHERE project_code = '".$_GET['project_code']."' AND no_so = '".$_GET['no_so']."'"; 
                                ...
                                <select id="projectType" class="form-control form-control-sm" name="projectType"
                                    ...
                                    <?php 
                                        $sqlCheckProjectType = "SELECT * FROM sa_wrike_project_list WHERE no_so = '".$_GET['no_so']."'"; 
                                        $dataPT = $DBWR->get_sql($sqlCheckProjectType);
                                        $rowDataPT = $dataPT[0];
                                        $resDataPT = $dataPT[1];
                            ...
                            <div class="col-sm-12 mb-2">
                                ...
                                <input type="text" class="form-control form-control-sm" id="customer"
                                    name="customerName"
                                    value="<?php if ($_GET['act'] == 'edit') {echo $ddata['customer_name'];} ?>"
                                    readonly>
                                <?php } else if ($_GET['act'] == "add" && isset($_GET['project_code']) && isset($_GET['no_so']) && isset($_GET['project_type'])){ 
                                    $sqlCheckData = "SELECT * FROM sa_wrike_project_list as a 
                                    JOIN sa_wrike_project_detail as b on a.id=b.project_id
                                    WHERE a.project_code = '".$_GET['project_code']."' AND a.no_so LIKE '%".$_GET['no_so']."%' AND a.project_type LIKE '%".$_GET['project_type']."%'";
                                    $dataCN = $DBWR->get_sql($sqlCheckData);
                                ?>
                                <input type="text" class="form-control form-control-sm" id="customer"
                                    name="customerName" value="<?php 
                                    if($dataCN[2] > 0){
                    ...
                    <?php
                    if(($_GET['act'] == "add" && isset($_GET['project_code']) && isset($_GET['no_so']) && isset($_GET['project_type'])) || $_GET['act'] == "edit") {
                    ?>
                    <div class="row mt-3">
                            ...
                            <div class="control-group after-add-more">
                                ...
                                <div class="col-sm-10 mb-2">
                                    <select id="email" class="form-control form-control-sm" name="email[]"
                                        ...
                                        <?php
                                            $sqlHCM = "SELECT * FROM sa_view_employees_v2 WHERE (job_structure LIKE '%JG%' OR job_structure LIKE '%LWW%' OR job_structure LIKE '%RBC%' OR job_structure LIKE '%Engineer%')  AND employee_email <> '' ORDER BY employee_name";
                                ...
                                <div class="col-md-5 mb-2">
                                    <input type="number" name="startProgress[]" id="startProgress"
                                ...
                                <label for="inputCID3" class="col-sm-6 col-form-label col-form-label-sm">End Progress
                                    (in Percent %)</label>
                                <div class="col-md-5 mb-2">
                                    <input type="number" name="endProgress[]" id="endProgress"
                                        class="form-control form-control-sm" style="display: inline-block;">
                                </div>
                                <div class="col-sm-10 mb-2">
                            ...
                            <div class="control-group after-add-more">
                                ...
                                <div class="col-sm-10 mb-2">
                                    <input type="text" name="email" id="email" class="form-control form-control-sm"
                                        style="display: inline-block;" value="<?php if ($_GET['act'] == 'edit') { 
                                            $currentEmail = explode("<", $ddata['resource_email']); 
                                            $currentEmail1 = str_replace(['>', ' '], '', $currentEmail[1]);

                                            echo $currentEmail[0] . " - ". $currentEmail1;}?>" readonly>
                                </div>
                                ...
                                <div class="col-sm-10 mb-2">
                                    <input type="text" name="email" id="email" class="form-control form-control-sm"
                                        ...
                                        value="<?php if ($_GET['act'] == 'edit') {echo $ddata['roles'];}?>" readonly>
                                </div>
                                ...
                                <div class="col-sm-10 mb-2">
                                    <input type="text" name="email" id="email" class="form-control form-control-sm"
                                        style="display: inline-block;"
                                        value="<?php if ($_GET['act'] == 'edit') {echo $ddata['project_roles'];}?>"
                                        readonly>
                                </div>
                                <?php
                                if(USERPERMISSION == '0162bce636a63c3ae499224203e06ed0' || USERPERMISSION == '7b7bc2512ee1fedcd76bdc68926d4f7b' || USERPERMISSION == 'dbf36ff3e3827639223983ee8ac47b42' || USERPERMISSION == '726ea0dd998698e8a87f8e344d373533'){
                                ?>
                                <label for="inputCID3" class="col-sm-3 col-form-label col-form-label-sm">Status</label>
                                <div class="col-sm-10 mb-2">
                                    <select class="form-control form-control-sm" name="status" id="statusEditApproval"
                                        ...
                                        <option
                                            value="<?php if ($_GET['act'] == 'edit') {$explodeStatus = explode(" ",$ddata['status']); echo $explodeStatus[0]; }?>">
                                ...
                                <div class="col-md-5 mb-2">
                                    <input type="number" name="startProgress" id="startProgressEdit"
                                        class="form-control form-control-sm" style="display: inline-block;"
                                        value="<?php if ($_GET['act'] == 'edit') {$explodeProgress = explode("%", $ddata['progress']); echo $explodeProgress[0]; }?>" required>
                                </div>
                                <label for="inputCID3" class="col-sm-6 col-form-label col-form-label-sm">End Progress
                                    (in Percent %)</label>
                                <div class="col-md-5 mb-2">
                                    <input type="number" name="endProgress" id="endProgressEdit"
                                        class="form-control form-control-sm" style="display: inline-block;"
                                        value="<?php if ($_GET['act'] == 'edit') {$explodeProgress = explode(" - ", $ddata['progress']); $explodeEnd = explode("%", $explodeProgress[1]); echo $explodeEnd[0]; }?>" required>
                                </div>
                                <div class="col-sm-10 mb-2">
                                    <label for="exampleFormControlTextarea1">Description (optional)</label>
                                    <textarea class="form-control" id="exampleFormControlTextarea1" name="description"
                                        rows="3"
                                        value=""><?php if ($_GET['act'] == 'edit') {echo $ddata['description'];}?></textarea>
                                </div>
                                <?php
                                }else{
                                ?>
                                ...
                                <div class="col-sm-10 mb-2">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" name="description"
                                        rows="3" value=""
                                        readonly><?php if ($_GET['act'] == 'edit') {echo $ddata['description'];}?></textarea>
                                </div>
                                <?php
                                }
                                ?>
                        ...
                        <div class="col-md-8">
                            ...
                            <table class="table table-hover" id="temporaryResourceTable">
                                ...
                                <tbody>
                                    ...
                                    $sqlLookupDataPCTemp = "SELECT * FROM sa_temporary_resource WHERE project_code = '$project_code' AND no_so = '$no_so' AND project_type = '$projectType'";
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <center>
                                                            <img src="components/modules/resource_assignment/img/delivery.gif"
                                                                width="100" height="100" data-aos="fade-up" /></center>
                                                    </div>
                                ...
                                <tbody>
                                    ...
                                    $no_so  = $_GET['no_so'];
                                    $projectType = $_GET['project_type'];
                                    $sqlLookupDataPCTemp = "SELECT * FROM sa_temporary_resource WHERE project_code = '$project_code' AND no_so = '$no_so' AND project_type = '$projectType' AND created_by LIKE '%".$_SESSION['Microservices_UserEmail']."%'";
                                    $dataPCTemp = $DTSB->get_sql($sqlLookupDataPCTemp);
                                    $rowDataPCTemp = $dataPCTemp[0];
                                    $resDataPCTemp = $dataPCTemp[1];
                                    $totalRowDataPCTemp = $dataPCTemp[2];
                    ...
                    <?php if(isset($_GET['act']) && $_GET['act']=='edit' && (USERPERMISSION == '0162bce636a63c3ae499224203e06ed0' || USERPERMISSION == '7b7bc2512ee1fedcd76bdc68926d4f7b' || USERPERMISSION == 'dbf36ff3e3827639223983ee8ac47b42' || USERPERMISSION == '726ea0dd998698e8a87f8e344d373533')) { ?>
                                ...
                                <div class="modal-body">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-12 text-center">
                                                <img src="components/modules/resource_assignment/img/checklist.gif"
                                ...
                                <div class="modal-body">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-12 text-center">
                                                <img src="components/modules/resource_assignment/img/trash.gif"
                                                    alt="Girl in a jacket" width="100" height="100" data-aos="fade-up">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-12 mt-5">
                        <?php
                            if($_GET['act'] == 'add' && isset($_GET['project_code']) && isset($_GET['no_so']) && isset($_GET['project_type'])){
                            ?>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php 
                                    $project_code  = $_GET['project_code'];
                                    $no_so  = $_GET['no_so'];
                                    $sqlLookupDataPC = "SELECT * FROM sa_resource_assignment WHERE project_code = '$project_code' AND no_so = '$no_so'";
                ...
                <script>
                    ...
                    function onChangeSOFunction() {
                        ...
                        window.location = window.location.pathname + "?mod=resource_assignment" +
                            "&act=<?php echo $_GET['act']; ?>" + "&project_code=" + project_code + "&no_so=" + no_so;
                    }
                    ...
                    $(document).ready(function () {
                        ...
                        $('#butsave').click(function () {
                            ...
                            var noSO = $('#noSO option:selected').val();
                            ...
                            if (email != "" && email != "#" && roles != "" && roles != ' - ' && roles !=
                                '#' && status != "" && startProgress != "" && endProgress != "" &&
                                projectId != '' && projectRoles != '' && projectRoles != '#') {
                                $.ajax({
                                    ...
                                    success: function (result) {
                                        if (result['notifId'] == 1) {
                                            ...
                                            alert(
                                                'CODE 404 - Ada kesalahan pada program !'
                                                );
                                        }
