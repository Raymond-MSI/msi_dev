...
<div class="tab-content" id="myTabContent">
                            ...
                            <div class="col-sm-12 mb-2">
                                ...
                                <select id="project_code" class="form-control form-control-sm" name="projectCode"
                                    ...
                                    <?php
                                            ...
                                            $rowData = $dataQuery[0];
                                            $resData = $dataQuery[1];
                                            if ($_SESSION['Microservices_UserEmail'] == 'miko.widiarta@mastersystem.co.id' || $_SESSION['Microservices_UserEmail'] == 'david.kusuma@mastersystem.co.id' || $_SESSION['Microservices_UserEmail'] == 'chrisheryanda@mastersystem.co.id' || $_SESSION['Microservices_UserEmail'] == 'aceng.zakariya@mastersystem.co.id' || $_SESSION['Microservices_UserEmail'] == 'zahira.nafira@mastersystem.co.id' || $_SESSION['Microservices_UserEmail'] == 'arieftyarto@mastersystem.co.id' || $_SESSION['Microservices_UserEmail'] == 'agdi.rizky@mastersystem.co.id' || $_SESSION['Microservices_UserEmail'] == 'nabella.yanza@mastersystem.co.id' || $_SESSION['Microservices_UserEmail'] == 'rezha.aulia@mastersystem.co.id' || $_SESSION['Microservices_UserEmail'] == 'aldo.octavianto@mastersystem.co.id' || $_SESSION['Microservices_UserEmail'] == 'zaimatul@mastersystem.co.id' || $_SESSION['Microservices_UserEmail'] == 'anggi.fachrizal@mastersystem.co.id' || $_SESSION['Microservices_UserEmail'] == 'lucky.andiani@mastersystem.co.id' || $_SESSION['Microservices_UserEmail'] == 'anita.angelina@mastersystem.co.id') {
    ...
    $('#butsavemt').click(function(event) {
        ...
        if (status !== "Penuh") {
            ...
            if (startDate && endDate) {
                ...
                const lastDay = new Date(lastDays);
                if (startDateObj < lastDay){
                    alert('Project sudah pernah direview dan tidak bisa menambahkan resource dengan status Penuh');
                    return;
                }
    ...
    <div class="tab-pane fade" id="mt_report" role="tabpanel" aria-labelledby="mt_report-tab">
        <?php include('form_maintenance_datelamaa.php') ?>
    </div>
    <?php } ?>
</div>
<?php
