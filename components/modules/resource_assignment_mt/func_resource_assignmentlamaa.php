...
function createTaskMT($order_number)
{
    ...
    $internal_name = $DBWR->get_sql("SELECT * from sa_initial_jobroles_project WHERE project_id='$projectID' AND jobroles_name LIKE '%1.%'");
    ...
    // // Jika ID ditemukan, tampilkan ID tersebut
    // if ($id2 !== null) {
    //     //ech
    // } else {
    //     //echo "Tidak ada ID yang ditemukan dengan judul yang mengandung '3.'";
    // }
