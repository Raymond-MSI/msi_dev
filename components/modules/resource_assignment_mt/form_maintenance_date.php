                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row mb-3" id="upload_compliance">
                                    <label for="assignment_note"
                                        class="col-sm-4 col-form-label col-form-label-sm">Data Compliance (Data Project)</label>
                                    <div class="col-sm-6">
                                        <div class="row mb-3">
                                            <div class="col-sm-12">
                                                <input type="file" class="form-control form-control-sm ajax-upload"
                                                    name="upload_file_compliance" data-type="data_project" data-row="1">
...
<script>
    $(document).ready(function () {
        $(".ajax-upload").on("change", function () {
            ...
            var projectCode = <?php echo $_GET['project_code']; ?>
            var orderNumber = <?php echo $_GET['order_number']; ?>
            ...
            if (file) {
                ...
                $.ajax({
                    url: "components/modules/resource_assignment_mt/upload.php",
                    type: "POST",
                    data: formData,
                    contentType: false,
                    processData: false,
                    ...
                    error: function (xhr, status, error) {
                        ...
                        statusDiv.html("<span style='color: red;'>Error pada server! " + xhr.responseText + "</span>");
                    }
                });
            }
        });
...
<!-- <script>
    $(document).ready(function () {
        $(".ajax-upload2").on("change", function () {
            var fileInput = $(this)[0];
            var file = fileInput.files[0];
            var fileType = $(this).data("type"); 
            var rowNumber = $(this).data("row"); 
