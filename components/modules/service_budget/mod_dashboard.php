...
// KP <=2020
//            $mysql = "select `solution_name`, avg(coalesce(`product`,0)) AS `product` from `sa_trx_project_list` join `sa_trx_project_solutions` on `sa_trx_project_list`.`project_id`=`sa_trx_project_solutions`.`project_id` where (`status`='approved' OR `status`='acknowledge') AND `so_number` IN (select `so_number` from `sa_trx_project_list` join `sa_trx_project_solutions` on `sa_trx_project_list`.`project_id`=`sa_trx_project_solutions`.`project_id` where (`status`='approved' OR `status`='acknowledge') AND `product`>0 AND (sa_" . $tblname . ".project_code like '______20%' OR sa_" . $tblname . ".project_code like '______1_%')" . " group by `so_number` order by `so_number`) group by `solution_name` order by `so_number`, `solution_name`;";
// KP =2021
//            $mysql = "select `solution_name`, avg(coalesce(`product`,0)) AS `product` from `sa_trx_project_list` join `sa_trx_project_solutions` on `sa_trx_project_list`.`project_id`=`sa_trx_project_solutions`.`project_id` where (`status`='approved' OR `status`='acknowledge') AND `so_number` IN (select `so_number` from `sa_trx_project_list` join `sa_trx_project_solutions` on `sa_trx_project_list`.`project_id`=`sa_trx_project_solutions`.`project_id` where (`status`='approved' OR `status`='acknowledge') AND `product`>0 AND sa_" . $tblname . ".project_code like '______21%'" . " group by `so_number` order by `so_number`) group by `solution_name` order by `so_number`, `solution_name`;";
// KP = NOW
            $mysql = "select `solution_name`, avg(coalesce(`product`,0)) AS `product` from `sa_trx_project_list` join `sa_trx_project_solutions` on `sa_trx_project_list`.`project_id`=`sa_trx_project_solutions`.`project_id` where (`status`='approved' OR `status`='acknowledge') AND `so_number` IN (select `so_number` from `sa_trx_project_list` join `sa_trx_project_solutions` on `sa_trx_project_list`.`project_id`=`sa_trx_project_solutions`.`project_id` where (`status`='approved' OR `status`='acknowledge') AND `product`>0 AND sa_" . $tblname . ".project_code like '______" . date("y") . "%'" . " group by `so_number` order by `so_number`) group by `solution_name` order by `so_number`, `solution_name`;";
...
// KP <= 2020
//            $mysql = "select `solution_name`, avg(coalesce(`services`,0)) AS `service` from `sa_trx_project_list` join `sa_trx_project_solutions` on `sa_trx_project_list`.`project_id`=`sa_trx_project_solutions`.`project_id` where (`status`='approved' OR `status`='acknowledge') AND `so_number` IN (select `so_number` from `sa_trx_project_list` join `sa_trx_project_solutions` on `sa_trx_project_list`.`project_id`=`sa_trx_project_solutions`.`project_id` where (`status`='approved' OR `status`='acknowledge') AND `services`>0 AND (sa_" . $tblname . ".project_code like '______20%' OR sa_" . $tblname . ".project_code like '______1_%')" . " group by `so_number` order by `so_number`) group by `solution_name` order by `so_number`;";
// KP = 2021
//            $mysql = "select `solution_name`, avg(coalesce(`services`,0)) AS `service` from `sa_trx_project_list` join `sa_trx_project_solutions` on `sa_trx_project_list`.`project_id`=`sa_trx_project_solutions`.`project_id` where (`status`='approved' OR `status`='acknowledge') AND `so_number` IN (select `so_number` from `sa_trx_project_list` join `sa_trx_project_solutions` on `sa_trx_project_list`.`project_id`=`sa_trx_project_solutions`.`project_id` where (`status`='approved' OR `status`='acknowledge') AND `services`>0 AND sa_" . $tblname . ".project_code like '______21%'" . " group by `so_number` order by `so_number`) group by `solution_name` order by `so_number`;";
// KP = Now
            $mysql = "select `solution_name`, avg(coalesce(`services`,0)) AS `service` from `sa_trx_project_list` join `sa_trx_project_solutions` on `sa_trx_project_list`.`project_id`=`sa_trx_project_solutions`.`project_id` where (`status`='approved' OR `status`='acknowledge') AND `so_number` IN (select `so_number` from `sa_trx_project_list` join `sa_trx_project_solutions` on `sa_trx_project_list`.`project_id`=`sa_trx_project_solutions`.`project_id` where (`status`='approved' OR `status`='acknowledge') AND `services`>0 AND sa_" . $tblname . ".project_code like '______" . date("y") . "%'" . " group by `so_number` order by `so_number`) group by `solution_name` order by `so_number`;";
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs mb-1 table-responsive">
                                        <table class="table table-sm">
                                            <thead>
                                                <tr class="border-bottom bg-light"><th>Solution Name (<?php echo date("Y"); ?>)</th><th class="text-center">Product</th><th class="text-center">Service</th></tr>
                                            </thead>
                                            <tbody>
