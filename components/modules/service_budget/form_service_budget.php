													...
													$get_role = $DTSB->get_sqlV2(
														"SELECT
															CASE
																...
																WHEN resource_level = 12 THEN 'Project Director'
																WHEN resource_level = 22 THEN 'Project Manager'
																WHEN resource_level = 32 THEN 'Project Coordinator'
																WHEN resource_level = 13 THEN 'Project Director'
																WHEN resource_level = 23 THEN 'Project Manager'
																WHEN resource_level = 33 THEN 'Project Coordinator'
																WHEN resource_level = 14 THEN 'Project Director'
																WHEN resource_level = 24 THEN 'Project Manager'
																WHEN resource_level = 34 THEN 'Project Coordinator'
																WHEN resource_level = 15 THEN 'Project Director'
																WHEN resource_level = 25 THEN 'Project Manager'
																WHEN resource_level = 35 THEN 'Project Coordinator'
															END AS position
														FROM
															sa_trx_project_mandays
														WHERE
															...
															AND resource_level IN (11,21,31,12,22,32,13,23,33,14,24,34,15,25,35)
														");
