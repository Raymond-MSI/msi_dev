...
} elseif($_GET['act']=="order" || $_GET['act']=="view") {
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control form-control-sm" style="text-align: right;" id="inputPODate" value="<?php 
                                                        if(isset($_GET['act']) && $_GET['act']=='add') {
                                                            echo date('d-M-Y', strtotime($dsb['po_date']));
                                                        } ?>" readonly name="po_date">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="input-group input-group-sm mb-1">
                                                        ...
                                                        ?>" <?php echo $adminpermission; ?> name="amount_idr" onchange="format_amount_idr();">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="input-group input-group-sm mb-1">
                                                        ...
                                                        <input type="text" class="form-control text-end" style="text-align: right;" id="amount_usd" value="<?php echo $dsb['amount_usd']; ?>" <?php echo $adminpermission; ?> name="amount_usd" onchange="format_amount_usd();">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group mb-1">
                                                        <input type="text" class="form-control" name="project_name_internal" id="project_name_internal" aria-label="Project Name Internal" aria-describedby="button-addon2" value="<?php 
                                                            if(isset($_GET['act']) && ($_GET['act']!='add' && $_GET['act']!='order')) { 
                                                                echo $dsb['project_name_internal']; 
                                                            } else {
                                                                echo date("Y") . " - " . $dsb['project_name'];
                                                            } ?>" readonly>
                                                        <button class="btn btn-outline-secondary" type="button" name="btn_project_name_internal" id="btn_project_name_internal" data-bs-toggle="modal" data-bs-target="#modal_project_name_internal" <?php if($ver>0 && ($dsb['status']=='submited' || $dsb['status']=='acknowledge') || $ver==0) { echo 'disabled'; } ?>>Edit</button>
                                                    </div>
                                                </div>
                                           </div>
                                            <div class="row mb-3">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row mb-3">
                                            <div class="col-sm-12">
                                            <textarea class="form-control" id="exampleNotes" name="note_approved" rows="3" placeholder="Berikan note..."></textarea>
                                            </div>
                                        </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row mb-3">
                                            <div class="col-sm-12">
                                            <textarea class="form-control" id="exampleNotes" name="note_rejected" rows="3" placeholder="Berikan note..."></textarea>
                                            </div>
                                        </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row mb-3">
                                            <div class="col-sm-12">
                                            <textarea class="form-control" id="exampleNotes" name="note_reopen" rows="3" placeholder="Berikan note..."></textarea>
                                            </div>
                                        </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row mb-3">
                                            <div class="col-sm-12">
                                            <textarea class="form-control" id="exampleNotes" name="note_acknowledge" rows="3" placeholder="Berikan note..."></textarea>
                                            </div>
                                        </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
...
<form method="get">
    <div class="modal fade" id="modal_project_name_internal" tabindex="-1" aria-labelledby="saveFinal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="saveAcknowledge"><b>Project Name Internal</b></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-sm-12">
                            <textarea class="form-control" id="note_project_name_internal" name="note_project_name_internal" rows="3" placeholder="Berikan Project Name Internal..." onkeyup="getlen();"><?php echo $ver>0 ? $dsb['project_name_internal'] : ""; ?></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <!-- <label for="inputKP3" class="col-sm-3 col-form-label col-form-label-sm">No. KP</label> -->
                        <div class="col-sm-12">
                            Jumlah karakter <span id="demo"></span> of 100.
                        </div>
                    </div>
                    <div class="modal-footer">
