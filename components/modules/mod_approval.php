...
?>
                    ...
                    buttons: [
                        ...
                        // },
                        {
                            ...
                            action: function() {
                                ...
                                var id = table.cell(rownumber, 0).data();
                                window.location.href = "index.php?mod=approval&act=edit&id=" + id + "&submit=Submit";
                            }
                        },
                        // {
        ...
        function view_data($tblname)
        {
            ...
            view_table($DBAPPROVAL, $tblname, $primarykey, $condition, $order);
        }
        function form_data($tblname)
        {
            include("components/modules/approval/form_approval.php");
        }

        // End Function

        $database = 'sa_new';
        include("components/modules/approval/connection.php");
        $DBAPPROVAL = new Databases($hostname, $username, $userpassword, $database);
        $tblname = 'trx_approval';

        include("components/modules/approval/func_approval.php");
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">trx_approval</h6>
                </div>
                <div class="card-body">
                    <?php
                    if (!isset($_GET['act'])) {
