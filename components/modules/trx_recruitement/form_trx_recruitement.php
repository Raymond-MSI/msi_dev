...
$query   = $DBREC->get_sql("SELECT * FROM sa_trx_recruitement");
...
// $nariknamadivisi = $DBHCM->get_sql("Select DISTINCT unit_name from sa_view_employees_v2 where employee_email is not null and unit_name is not null ORDER BY unit_name ASC");
$nariknamadivisi = $DBHCM->get_sql("Select DISTINCT unit_name from sa_view_employees_v2 where employee_email = '$user'");
...
$aproval_gm = $DBHCM->get_data("view_employees_v2", "resign_date IS NULL ORDER BY employee_name ASC");
// $user = $_SESSION['Microservices_UserEmail'];
// var_dump($user);
// $aproval_bod = $DBHCM->get_data("view_employees","resign_date IS NULL ORDER BY employee_email ASC");
// $aproval_gm_hcm = $DBHCM->get_data("view_employees","resign_date IS NULL ORDER BY employee_email ASC");
                                        ...
                                        <select class="form-control" name="divisi" id="divisi">
                                            <?php if ($_GET['act'] == "add") { ?>
                                                <?php if (isset($_GET['divisi'])) {
                                                    $namadivisi = $DBHCM->get_data("view_employees_v2", "unit_name = '" . $_GET['divisi'] . "'"); ?>
                                                    <option value="<?php echo $namadivisi[0]['unit_name']; ?>"><?php echo $namadivisi[0]['unit_name']; ?></option>
                                                <?php } ?>
                                                <option></option>
                                                <?php do { ?>
                                                    <option value="<?php echo $nariknamadivisi[0]['unit_name']; ?>"><?php echo $nariknamadivisi[0]['unit_name']; ?></option>
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control" name="divisi" id="divisi">
                                                        <?php if ($_GET['act'] == "edit") { ?>
                                                            <?php $query = $DBREC->get_sql("SELECT * FROM sa_trx_recruitement where id=" . $ddata['id'] . ""); ?>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputCID3" class="col-sm-3 col-form-label col-form-label-sm">Kompetensi Teknis Yang Harus Dikuasai</label>
                                                <div class="col-sm-9">
                                                    <textarea type="text" class="form-control" id="kompetensi_teknis" name="kompetensi_teknis" rows="2"><?php if ($_GET['act'] == 'edit') {
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputCID3" class="col-sm-3 col-form-label col-form-label-sm">Kompetensi Non Teknis Yang Harus Dikuasai</label>
                                                <div class="col-sm-9">
                                                    <textarea type="text" class="form-control" id="kompetensi_non_teknis" name="kompetensi_non_teknis" rows="2"><?php if ($_GET['act'] == 'edit') {
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputCID3" class="col-sm-3 col-form-label col-form-label-sm">Catatan</label>
                                                <div class="col-sm-9">
                                                    <textarea type="text" class="form-control form-control-sm" id="catatan" name="catatan" rows="2"><?php if ($_GET['act'] == 'edit') {
                                                                                                                                                        echo $ddata['catatan'];
                                                                                                                                                    } ?></textarea>
                                                </div>
                                            </div>
                    ...
                    <?php } else if ($ddata['gm_hcm'] == $_SESSION['Microservices_UserEmail'] || $ddata['gm'] == $_SESSION['Microservices_UserEmail']) { ?>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control" name="gm" id="gm">
                                                    <?php if ($_GET['act'] == "add") { ?>
                                                        <?php if (isset($_GET['divisi'])) {
                                                            $approv_gm = $DBHCM->get_data("view_employees", "resign_date IS NULL AND job_level=2"); ?>
                                                            <option></option>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control" name="gm_hcm" id="gm_hcm">
                                                    <?php if ($_GET['act'] == "add") { ?>
                                                        <?php if (isset($_GET['divisi'])) {
                                                            $approv_gm_hcm = $DBHCM->get_data("view_employees", " `organization_name` LIKE '%human capital management%' AND `job_level` = 2 AND `resign_date` IS NULL"); ?>
                                                            <option></option>
                                                            <option value="malik.aulia@mastersystem.co.id">malik.aulia@mastersystem.co.id</option>
                                                            <?php do { ?>
                        ...
                        <script>
                            $("#divisi").on('change', function() {
                                ...
                                window.location = window.location.pathname + "?mod=trx_recruitement" + "&act=add&divisi=" + divisi;
                            })
                        </script>