                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="row mb-3" id="reason-row">
                            <label for="inputCID3" class="col-sm-3 col-form-label col-form-label-sm">Nama Karyawan Lama <b>*</b></label>
                            <div class="col-sm-9">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="card shadow mb-1">
                                    <div class="card-header fw-bold">Background</div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="row mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="row mb-3">
                                                    <label for="inputCID3" class="col-sm-3 col-form-label col-form-label-sm">Status Leader <b>*</b></label>
                                                    <div class="col-sm-9">
                                                        <?php if ($_GET['act'] == "editdraft" && $ddata['status_gm'] == "Pending") { ?>
