...
$password = 'malikaja0856'; // Ensure this is your actual app-specific password
                ...
                if ($view['status_rekrutmen'] == 'Penambahan') {
                    if ($view['id_fpkb'] == $extractedPart && $view['status_gm'] == 'Pending') {
                        ...
                        if (stripos($fromemail, $emailgm) !== false) {
                            ...
                            $msg .= '                <tr><td style="width: 20%;">Notes</td><td>:</td><td>' . htmlspecialchars($status_gm) . '</td></tr>';
                            $msg .= '                <tr><td style="width: 20%;">Status</td><td>:</td><td>' . htmlspecialchars($catatan_gm) . '</td></tr>';
                            $msg .= '            </table>';
                            $msg .= '        <table>';
                            $msg .= '        <tr>';
                            $msg .= '        </table>';
                            ...
                            if ($updateResult) {
                                ...
                                $msg .= '                <tr><td style="width: 20%;">Reason</td><td>:</td><td>' . htmlspecialchars($view['status_rekrutmen']);
                                if (
                                    $view['status_rekrutmen'] == 'Penggantian'
                                ) {
                                    $msg .= ' ' . htmlspecialchars($view['reason_penggantian']);
                                }
                                $msg .= '</td></tr>';
                    ...
                    if ($view['id_fpkb'] == $extractedPart && $view['status_gm'] == 'Approve' && $view['status_gm_hcm'] == 'Pending') {
                        if (stripos($fromemail, $emailgm_hcm) !== false) {
                            ...
                            $queryjoblevel = "SELECT * FROM sa_view_employees WHERE employee_name like '%$fromemail%'";
                            ...
                            $msg .= '                <tr><td style="width: 20%;">Notes</td><td>:</td><td>' . htmlspecialchars($status_hcm) . '</td></tr>';
                            $msg .= '                <tr><td style="width: 20%;">Status</td><td>:</td><td>' . htmlspecialchars($catatan_hcm) . '</td></tr>';
                            $msg .= '            </table>';
                            $msg .= '        <table>';
                            $msg .= '        <tr>';
                            $msg .= '        </table>';
                    ...
                    if ($view['id_fpkb'] == $extractedPart && $view['status_gm'] == 'Approve' && $view['status_gm_hcm'] == 'Approve' && $view['status_gm_bod'] == 'Pending') {
                        ...
                        if (stripos($fromemail, $emailbod) !== false) {
                            ...
                            $msg .= '                <tr><td style="width: 20%;">Status</td><td>:</td><td>' . htmlspecialchars($view['catatan_gm_hcm']) . '</td></tr>';
                ...
                if ($view['status_rekrutmen'] == 'Penggantian') {
                    if ($view['id_fpkb'] == $extractedPart && $view['status_gm'] == 'Pending') {
                        if (stripos($fromemail, $emailgm) !== false) {
                            ...
                            $msg .= '                <tr><td style="width: 20%;">Position</td><td>:</td><td>' . htmlspecialchars($view['posisi']) . '</td></tr>';
                            $msg .= '                <tr><td style="width: 20%;">Job Description</td><td>:</td><td>' . htmlspecialchars($view['deskripsi']) . '</td></tr>';
                            $msg .= '                <tr><td style="width: 20%;">Reason</td><td>:</td><td>' . htmlspecialchars($view['status_rekrutmen']) . '</td></tr>';
                            $msg .= '                <tr><td style="width: 20%;">Status Employee</td><td>:</td><td>' . htmlspecialchars($view['status_karyawan']);
                            if ($view['status_karyawan'] == 'Kontrak') {
                                $msg .= ' ' . htmlspecialchars($view['deskripsi_kontrak']);
                            }
