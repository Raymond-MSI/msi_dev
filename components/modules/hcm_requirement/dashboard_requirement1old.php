...
";
 ...
 AND YEAR(join_date) = '" . $currentYear . "'
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="contentPending" role="tabpanel" aria-labelledby="pending-tab">
                                        <?php
                                        $query = "SELECT a.id_fpkb, a.assign_requirement, a.divisi, a.request_by, a.posisi, a.status_rekrutmen, a.status_karyawan, a.reason_penggantian, a.nama_project, a.project_code, a.jumlah_dibutuhkan, a.request_date, a.tanggal_dibutuhkan, b.join_date, b.nama_kandidat, a.pendidikan_minimal, a.jurusan FROM sa_hcm_requirement a LEFT JOIN sa_hcm_requirement_interview b ON a.id_fpkb = b.id_fpkb ORDER BY `b`.`nama_kandidat`;
;";
