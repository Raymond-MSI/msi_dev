...
if (isset($_POST['add'])) {
    ...
    if ($_POST['status_rekrutmen'] == 'Penambahan' && $_POST['status_gm'] == 'Approve' && $_POST['status_gm_hcm'] == 'Pending' && $_POST['status_gm_bod'] == 'Pending') {
        // $to = "malik.aulia@mastersystem.co.id";
        $linkdissaprove = 'mailto:repoadmin@mastersystem.co.id?subject=[Permohonan Approval] Request Recruitment-' . $idfpkb . '&body=[Dissaprove] - hcm%0D%0A[notes] - hcm';
        $linkapprove = 'mailto:repoadmin@mastersystem.co.id?subject=[Permohonan Approval] Request Recruitment-' . $idfpkb . '&body=[Approve] - hcm%0D%0A[notes] - hcm';
        $to = $_POST['gm_hcm'];
        $from = "MSIZone<msizone@mastersystem.co.id>";
        $cc = "recruitment.team@mastersystem.co.id";
        $bcc = "";
    ...
    if ($_POST['status_rekrutmen'] == "Penggantian" && $_POST['status_gm'] == 'Approve' && $_POST['status_gm_hcm'] == 'Pending') {
        $linkdissaprove = 'mailto:repoadmin@mastersystem.co.id?subject=[Permohonan Approval] Request Recruitment-' . $idfpkb . '&body=[Dissaprove] - hcm%0D%0A[notes] - hcm';
        $linkapprove = 'mailto:repoadmin@mastersystem.co.id?subject=[Permohonan Approval] Request Recruitment-' . $idfpkb . '&body=[Approve] - hcm%0D%0A[notes] - hcm';
        $to = $_POST['gm_hcm'];
        $from = "MSIZone<msizone@mastersystem.co.id>";
    ...
    if ($_POST['status_rekrutmen'] == "Penambahan" && $_POST['status_gm'] == 'Approve' && $_POST['status_gm_hcm'] == 'Approve' && $_POST['status_gm_bod'] == 'Pending') {

        $linkdissaprove = 'mailto:repoadmin@mastersystem.co.id?subject=[Permohonan Approval] Request Recruitment-' . $idfpkb . '&body=[Dissaprove] - bod%0D%0A[notes] - bod';
        $linkapprove = 'mailto:repoadmin@mastersystem.co.id?subject=[Permohonan Approval] Request Recruitment-' . $idfpkb . '&body=[Approve] - bod%0D%0A[notes] - bod';
        $to = $_POST['bod'];
        $from = "MSIZone<msizone@mastersystem.co.id>";
        $cc = "recruitment.team@mastersystem.co.idco.id";
        $bcc = "";
    ...
    if ($_POST['status_rekrutmen'] == "Penggantian" && $_POST['status_gm'] == 'Approve' && $_POST['status_gm_hcm'] == 'Approve') {
        ...
        $msg .= '<tr><td>Status Karyawan</td><td>:</td><td>' . $_POST['status_karyawan'] . '</td></tr>';
        $msg .= '<tr><td>Kandidat</td><td>:</td><td>' . $_POST['kandidat'] . '</td></tr>';
        $msg .= '<tr><td>Status</td><td>:</td><td>Submitted</td></tr>';
        $msg .= '</table>';
        $msg .= '</p>';
    ...
    if ($_POST['status_rekrutmen_edit'] == 'Penambahan') {
        ...
        $from = $_POST['gm_hcm'];
        // $cc = "recruitment.team@mastersystem.co.id";
        $cc = $_POST['gm'] . ',' . $_POST['gm_hcm'] . ',recruitment.team@mastersystem.co.id';
    ...
    $from = "MSIZone<msizone@mastersystem.co.id>";
    // $cc = "recruitment.team@mastersystem.co.id";
    $cc = $_POST['gm_bod'] . ',' . $_POST['gm'] . ',' . $_POST['gm_hcm'] . ',recruitment.team@mastersystem.co.id';
    $kp = $_POST['project_code'];
    $id = $_POST['id'];
    $link = 'https://msizone.mastersystem.co.id/index.php?mod=hcm_requirement&act=editapproval&id=' . $id . '&project_code=' . $kp . '&submit=Submit';
    $bcc = "";
    ...
    //     if ($_POST['status_rekrutmen'] == 'Penggantian') {
    //         if ($_POST['gm'] == $_SESSION['Microservices_UserName'] . "<" . $_SESSION['Microservices_UserEmail'] . ">" || $HCMfull[2] > 0) {
    ...
    //             $res = $DBHCM->update_data($tblname, $update, $condition);
    //             $project_code = $_POST['project_code'];
    //             $description = $userName . " Telah memberikan " . $_POST['status_gm'] . " pada data dengan KP " . $_POST['project_code'];
    //             $insert = sprintf(
    ...
    //             }
    //         }
    //         if ($_POST['gm_hcm'] == $_SESSION['Microservices_UserName'] . "<" . $_SESSION['Microservices_UserEmail'] . ">" || $HCMfull[2] > 0) {
    //             if ($_POST['status_gm'] == "Disapprove" || $_POST['status_gm_hcm'] == "Disapprove") {
    //                 $status_request = 'Inactive';
    //             } else {
    //                 $status_request = 'Pending Approval';
    ...
    //             $res = $DBHCM->update_data($tblname, $update, $condition);
    //             $project_code = $_POST['project_code'];
    //             $description = $userName . " Telah memberikan " . $_POST['status_gm_hcm'] . " pada data dengan KP " . $_POST['project_code'];
    //             $insert = sprintf(
    //                 "(`project_code`,`description`,`entry_by`) VALUES (%s,%s,%s)",
    //                 GetSQLValueString($project_code, "text"),
    //                 GetSQLValueString($description, "text"),
    ...
    //             }
    //         }
    //         if ($_POST['gm_bod'] == $_SESSION['Microservices_UserName'] . "<" . $_SESSION['Microservices_UserEmail'] . ">" || $HCMfull[2] > 0) {
    ...
    //             $res = $DBHCM->update_data($tblname, $update, $condition);
    //             $project_code = $_POST['project_code'];
    //             $description = $userName . " Telah memberikan " . $_POST['status_gm_bod'] . " pada data dengan KP " . $_POST['project_code'];
    //             $insert = sprintf(
    //                 "(`project_code`,`description`,`entry_by`) VALUES (%s,%s,%s)",
    //                 GetSQLValueString($project_code, "text"),
    //                 GetSQLValueString($description, "text"),
    ...
    if (isset($_POST['email'])) {
        ...
        foreach ($_POST['email'] as $index => $email) {
            $insert_sql = sprintf(
                "(`id_fpkb`, `project_code`, `nama_kandidat`, `email`, `tanggal_interview`, `link_webex`, `pic`, `interview_hcm`, `interview_user`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                GetSQLValueString($_POST['id_fpkb'], "text"),
                GetSQLValueString($_POST['project_code'], "text"),
            ...
            // Attachments
            $attachments = array(
                "components/modules/hcm_requirement/keteranganpelamar.xlsx" => "keteranganpelamar.xlsx",
    ...
    if ($_POST['status_karyawan'] == "Percobaan") {
        ...
        $msg .= '<tr><td>Posisi</td><td>:</td><td>' . $_POST['posisi'] . '</td></tr>';
        $msg .= '<tr><td>Kode Project</td><td>:</td><td>' . $_POST['project_code'] . '</td></tr>';
        $msg .= '<tr><td>Status Requirement</td><td>:</td><td>' . $status_rekrutmen . '</td></tr>';
        $msg .= '<tr><td>Status Karyawan</td><td>:</td><td>' . $_POST['status_karyawan'] . '</td></tr>';
