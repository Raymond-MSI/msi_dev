<div class="card shadow mb-4">
    ...
    <h6 class="m-0 font-weight-bold text-secondary">Sales Order</h6>
    </div>
    <div class="card-body">
        <div class="row mb-2">
            <?php
                ...
                <div class="card border-left-danger shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Released</div>
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
            ...
            <?php
            $condition = "so_date >= '" . date("Y-m-d", strtotime("-1 day"), ) . "'";
            $order = "so_date DESC";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-9">
                                        ...
                                        <table class="table table-sm">
                                            <tr class="bg-light"><th>SO Date</th><th>Project Code</th><th>SO Number</th><th>Sales Name</th></tr>
                                            <?php
                                            if($orders[2]>0) {
                                                do {
                                                    echo "<tr><td class='align-text-top'>" . date("d-m-Y", strtotime($orders[0]['so_date'])) . "</td><td class='align-text-top'>" . $orders[0]['project_code'] . "</td><td class='align-text-top'>" . $orders[0]['so_number'] . "</td><td class='align-text-top'>" . $orders[0]['sales_name'] . "</td></tr>";
