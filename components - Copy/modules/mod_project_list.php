...
if((isset($property)) && ($property == 1)) {
    ...
    echo '<input type="hidden" id="organization_name" name="organization_name" value="' . $users[0]['organization_name'] . '">';
    echo '<input type="hidden" id="user_level" name="user_level" value="' . $_SESSION['Microservices_UserLevel'] . '">';
    echo '<input type="hidden" id="user_name" name="user_name" value="' . $_SESSION['Microservices_UserLogin'] . '">';
        ...
        <script> 
            $(document).ready(function() {
                    ...
                    buttons: [
                        {
                            ...
                            action: function () {
                                ...
                                if(so_number!="") {
                                    ...
                                    alert("SO Number kosong. Silahkan pilih yang ada Order Number-nya.");
                                }
                            }
                        }
                    ],
                ...
                table.on( 'select deselect', function () {
                    ...
                    if((amount_idr >= 200000000 || amount_usd >= 14000 || sales_type.search('Installation') >= 0 || sales_type.search('Maintenance') >= 0 || sales_type.search('Implementation') >= 0) && organization_name == 'Solution Engineering' ) {
                        table.button(0).enable();
                    } else if((sales_type=='Trade' || sales_type.search("Lease")>=0 || sales_type.search("Rent")>=0 || sales_type=='') && (organization_name.search("Marketing")>=0 || organization_name.search("Sales")>=0 || organization_name.search("Telesales")>=0 || organization_name == 'Solution Engineering') && (amount_idr<200000000 || amount_usd<14000)) {
                        table.button().enable();
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-secondary">Select Sales Order</h6>
                    <?php spinner(); ?>
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        $projects = $DPNAV->get_data($tblname, $conditionsb, $order);
                        if($projects[2]==0) {
                            ?>
                            <script>alert("Data SO belum ada. Silahkan menghubungi AM!");</script>
                            <?php
                        } elseif($projects[2]==1) {
            ...
            <div class="modal-dialog">    
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Filter Sales Order</h5>
