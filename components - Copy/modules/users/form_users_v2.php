...
function module($title, $module_name, $dusers)
{
    ...
    ?>
        <div class="row">
            ...
            <!-- <div class="col-sm-1 text-center border border-light">
                <div class="form-check">
                    <input class="form-check-input" type="radio" id="<?php //echo $module_name; ?>_edit" name="<?php //echo $module_name; ?>" value="Edit" <?php //echo (isset($permission[$module_name]) && $permission[$module_name]=="Edit") ? "Checked" : ""; ?>>
                </div>
            </div> -->
            <div class="col-sm-1 text-center border border-light">
                <div class="form-check">
            ...
            <div class="col-sm-1 text-center border border-light">
                <div class="form-check">
                    <input class="form-check-input" type="radio" id="<?php echo $module_name; ?>_user" name="<?php echo $module_name; ?>" value="User Admin" <?php echo (isset($permission[$module_name]) && $permission[$module_name]['user_level']=="User Admin") ? "Checked" : ""; ?>>
                </div>
            </div>
            <div class="col-sm-1 text-center border border-light">
                <div class="form-check">
                    <input class="form-check-input" type="radio" id="<?php echo $module_name; ?>_super" name="<?php echo $module_name; ?>" value="Super Admin" <?php echo (isset($permission[$module_name]) && $permission[$module_name]['user_level']=="Super Admin") ? "Checked" : ""; ?>>
                </div>
            </div>
            <div class="col-sm-1 text-center border border-light">
                <div class="form-check">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="row mb-3">
                ...
                <label for="inputCID3" class="col-sm-2 col-form-label col-form-label-sm">Status Active</label>
                <div class="col-sm-1">
                    <div class="form-check">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="col-sm-1 border bg-light border border text-center">
                    <label for="inputCID3" class="col-form-label col-form-label-sm fw-bold">User Admin</label>
                </div>
                <div class="col-sm-1 border bg-light border border text-center">
                    <label for="inputCID3" class="col-form-label col-form-label-sm fw-bold">Super Admin</label>
                </div>
                <div class="col-sm-1 border bg-light border border text-center">
