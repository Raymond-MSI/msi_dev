                ...
                var tableApprovedTrade = $('#view_project_list2').DataTable( {
                    ...
                    buttons: [
                        ...
                        },
                        {
                            text: "<span class='d-inline-block' tabindex='0' data-bs-toggle='tooltip' title='Edit SB'><i class='fa fa-pen'></i></span>",
                            action: function () {
                                var rownumber = tableApprovedTrade.rows({selected: true}).indexes();
                    ...
                    buttons: [
                        ...
                        },
                        {
                            ...
                            action: function () {
                                ...
                                var so_number = tableTempApproved.cell( rownumber,2 ).data(); alert(project_code);
                ...
                var tableAcknowledge = $('#view_project_list4').DataTable( {
                    ...
                    buttons: [
                        ...
                        },
                        {
                            text: "<span class='d-inline-block' tabindex='0' data-bs-toggle='tooltip' title='Edit SB'><i class='fa fa-pen'></i></span>",
                            action: function () {
                                var rownumber = tableAcknowledge.rows({selected: true}).indexes();
                                var project_code = tableAcknowledge.cell( rownumber,1 ).data();
                                var so_number = tableAcknowledge.cell( rownumber,2 ).data(); alert(project_code);
        ...
        function view_data($tblname) {
            ...
            if($filter!="") {
                ...
                if($check[2]>0) {
                    ...
                    ?>
                    <script>alert("<?php echo 'Berikut status Service Budget yang dimaksudkan :\r\nDraft : ' . $draft . '\r\nSubmit : ' . $submit . '\r\nApproved : ' . $approved . '\r\nTemporary/Acknowledge : ' . $acknowledge . '\r\nCreated by : ' . $names[1]; ?>");</script>
                    <?php
                } else {
                    ?>
                    <script>alert("Service Budget belum ada.");</script>
                    <?php
                }
            }
            ?>
