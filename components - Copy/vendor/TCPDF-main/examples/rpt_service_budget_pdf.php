...
$mysql = "SELECT * FROM `sa_trx_project_list` WHERE `project_code`='" . $_GET['project_code'] . "' AND (`so_number`='" . $_GET['so_number'] . "' OR `order_number`='" . $_GET['order_number'] . "') ORDER BY project_id DESC";
        ...
        <td width="47%">
            ...
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                ...
                <tr>
                    ...
                    <td>' . $dproject['project_name_internal'] . '</td>
                </tr>
                <tr>
                    <td colspan="2">&nbsp;</td>
                </tr>
        ...
        <td width="47%">
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                ...
                <tr>
                    ...
                    $condition = "project_id=" . $dproject['project_id'] . " AND `approve_status`='Approved'";
                ...
                <tr>
                    ...
                    <td>';
                        ...
                        //     $tbl.= "Submit"; 
                        // } elseif($dproject['status']=='approved' && $dproject['po_number']!=NULL && $dproject['so_number']!=NULL && $dproject['order_number']!=NULL) {
                        //     $tbl.= "Approved";
                        // } elseif($dproject['status']=='acknowledge' && $dproject['po_number']!=NULL && $dproject['so_number']!=NULL && $dproject['order_number']!=NULL) {
                        //     $tbl.= "Acknowledge";
                        // } else {
                        //     $tbl.= "Temporary (PO atau SO atau Order Number belum ada)";
                        // } 

                        $tblname = 'trx_approval';
                        $condition = "project_id=" . $dproject['project_id'] . " AND `approve_status`='Acknowledge'";
                        $order = "approve_id DESC";
                        $mysql = 'SELECT approve_by FROM sa_' . $tblname . ' WHERE ' . $condition . ' ORDER BY ' . $order;
                        $qapprove = mysqli_query( $DBSB, $mysql ) or die($DBSB->errno . "-" . "[open_db][mysqli_query][" . $mysql . "] - " . $DBSB->error . "<br/>");
                        $dapprove = mysqli_fetch_assoc( $qapprove );
