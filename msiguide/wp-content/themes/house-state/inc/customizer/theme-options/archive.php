...
$wp_customize->add_setting( 'house_state_theme_options[read_more_text]', array(
	'sanitize_callback' => 'sanitize_text_field',
	'default'			=> $options['read_more_text'],
) );

$wp_customize->add_control( 'house_state_theme_options[read_more_text]', array(
	'label'           	=> esc_html__( 'Read More Text Label', 'house-state' ),
	'section'        	=> 'house_state_archive_section',
	'type'				=> 'text',
) );
